...
public class SearchBoardController {
	...
	public void listPage(@ModelAttribute("criteria") SearchCriteria criteria,
		...
		//pageMaker.setTotalCount(service.listCountCriteria(criteria)); // 전체 데이터 갯수
		pageMaker.setTotalCount(service.listSearchCount(criteria)); //검색 조건에 갯수
		...
		public void read(@RequestParam("bno") int bno, @ModelAttribute("criteria") SearchCriteria criteria,
				Model model) throws Exception{
