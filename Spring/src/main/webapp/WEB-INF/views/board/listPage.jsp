...
<div class="box-header with-border">
	...
	<option value="10" 
	     <c:out value="${criteria.perPageNum == 10 ?'selected':''}"></c:out>>10개 씩 보기
	</option>
	<option value="20" 
	     <c:out value="${criteria.perPageNum == 20 ?'selected':''}"></c:out>>20개 씩 보기
	</option>
	<option value="30" 
	     <c:out value="${criteria.perPageNum == 30 ?'selected':''}"></c:out>>30개 씩 보기
	</option>
	<option value="50" 
	     <c:out value="${criteria.perPageNum == 50 ?'selected':''}"></c:out>>50개 씩 보기
	</option>
	<option value="100" 
	     <c:out value="${criteria.perPageNum == 100 ?'selected':''}"></c:out>>100개 씩 보기
	</option>
	</select>
</div>
